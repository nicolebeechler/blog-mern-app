...
function ShowPage(props) {
  ...
  }, "Delete Blog") : /*#__PURE__*/React.createElement(React.Fragment, null), /*#__PURE__*/React.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_4__.Link, {
    to: '/'
  }, "Go to HomePage"));
}
...
.O2NCX3pelTmVHMEJzuh5 {
  ...
  justify-content: center;
  align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/components/LoginForm/LoginForm.module.scss"],"names":[],"mappings":"AAAA;EACI,eAAA;EACA,WAAA;EACA,kBAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AACJ","sourcesContent":[".heading {\n    font-size: 2rem;\n    color: pink;\n    text-align: center;\n}\n\n.form {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
